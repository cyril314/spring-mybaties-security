...
public class DefaultSecurityMetadataSource extends JdbcDaoSupport implements FilterInvocationSecurityMetadataSource {
    ...
    public DefaultSecurityMetadataSource(DataSource dataSource) {
        log.info("=> 启动第一步, 初始化，读取数据库所有的url、角色");
    ...
    private void loadResourceDefine() {
        ...
        if (query != null) {
            ...
            log.info("=> 匹配请求路径集合：" + requestMap.toString());
        }
    }
    ...
    public Collection<ConfigAttribute> getAttributes(Object object) throws IllegalArgumentException {
        ...
        while (ite.hasNext()) {
            ...
            if (requestMatcher.matches(filterInvocation.getHttpRequest())) {
                ...
                log.info("===================> 匹配成功返回集合：" + retCollection);
    ...
    public Collection<ConfigAttribute> getAllConfigAttributes() {
        ...
        log.info("=> 总共有这些权限：" + attributes.toString());
        return attributes;
    }
